...
//					r._rendered = t('<li><a href="{url}"><div class="size">{size}</div><div class="title"><h{heading}>{name}</h{heading}>{stat}</div>{description}</a><div class="tags">'+tags+'</div></li>', r)
            r._rendered = t('<li><a href="{url}"><div class="size">{conpany_active_date}</div><div class="title"><h{heading}>{conpany_tax}</h{heading}>{stat}</div>{company_name}</a><div class="tags">'+tags+'</div></li>', r)					
          }
